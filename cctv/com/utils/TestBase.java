...
public class TestBase extends TestData {
	...
	private void setDriver(String browserName, String appURL) throws Exception {

		if (browserName.equals("chrome")) {
			System.setProperty("webdriver.chrome.driver", "E:\\Automation\\chromedriver_win32\\chromedriver.exe");
			driver = new ChromeDriver();
		} else if (browserName.equals("FF")) {
			System.setProperty("webdriver.gecko.driver", "D:/Vishal/Software/jars/geckodriver.exe");
		...
		/*
		 * switch (browserType) { case "chrome": driver = initChromeDriver(appURL);
		 * break; case "firefox": driver = initFirefoxDriver(appURL); break; default:
	 ...
	 * return driver; }
	 * 
	 * private static WebDriver initFirefoxDriver(String appURL) throws
	 * FileNotFoundException, IOException {
	 * System.out.println("Launching Firefox browser.."); log.info("log4j set");
	 * System.setProperty("webdriver.gecko.driver",
	 * "E:\\Automation\\geckodriver-v0.19.1-win64\\geckodriver.exe"); WebDriver
	 * driver = new FirefoxDriver(); driver.manage().window().maximize();
	 * driver.navigate().to(appURL); driver.manage().timeouts().implicitlyWait(10,
